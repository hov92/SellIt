...
- 👉 Heroku Mirror: [https://react-sellit-mirror.herokuapp.com](https://react-sellit-mirror.herokuapp.com)
...
```
$ git clone git@github.com:basir/sellit.git
$ cd sellit
```
...
- Local MongoDB
  ...
  - Set MONGODB_URL=mongodb://localhost/sellit  
- Atlas Cloud MongoDB
...
- Q/A: https://webacademy.pro/sellit
...
45. Publish To Heroku
    ...
    4. heroku login
    5. heroku apps:create <yourname>sellit
